...
<head>
    ...
    <meta name="description" content="Onest Developers is leading web solutions company.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Chose us and just relax">
              ...
              <ul class="sidenav">
                ...
                <li class="sidenav-item has-subnav active">
                  ...
                  <ul class="sidenav-subnav collapse">
                    ...
                    <li class="active"><a href="dynamic-tables.html">Dynamic tables</a></li>
                  </ul>
                </li>
                <li class="sidenav-item">
                  <a href="charts.html">
      ...
      <div class="layout-content">
        <div class="layout-content-body">
          ...
          <div class="text-center m-b">
            <a class="btn btn-warning" href="addc.php" style="background-color:#D9230F" >Add Company</a>
          </div>
          <div class="row">
            <div class="col-xs-12">
              <div class="panel">
...
<?php 
		...
		if($result = mysqli_query($link,$query)){
			...
			while ($row = mysqli_fetch_array($result)) {
				...
				$contact = $row[2];
				//$status = $row[3];
				$query1 = "Select reason from reason_trial where reason_id=".$row[3];
				...
				//$assign = $row[6];
				if($row[6]!=0){
					$query1 = "Select fname,lname from salesman where sid=".$row[6];
					if($result1 = mysqli_query($link,$query1)){
						while ($row1 = mysqli_fetch_array($result1)) {
							$assign = $row1[0]." ".$row1[1];
						}
					}
					else{
						$assign = "No";
				...
				echo '
                          ...
                          <td data-order="'.$status.'">
                            <span class="label label-info label-pill">'.$status.'</span>
                          </td>
                          <td data-order="'.$priority.'">'.$priority.'</td>
                          <td data-order="'.$assign.'">'.$assign.'</td>
                          <td>
                            <div class="btn-group pull-right dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right">
							  <li><a href="companyprofile.php?cid='.$cid.'">View Full Details</a></li>
                                <li><a >Assigned to </a></li>
