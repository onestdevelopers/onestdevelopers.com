...
if(isset($_POST["name"])&& isset($_POST["contact"] )&& isset($_POST['status']) && isset($_POST['priority']))
{
	...
	if(1)
	{
		$query = "INSERT INTO `client` (`name`, `contact`, `status`, `date`, `priority`, `assigned_to`) VALUES ('{$name}','{$contact}','{$status}','{$date}','{$priority}','{$assign}')";
...
<head>
  ...
  <body class="layout layout-header-fixed">
    ...
    <div class="layout-main">
        ...
        <div class="layout-content-body">
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">Add company Information</span>

            </h1>
            <p class="title-bar-description">
              <small>This form is concerned for new company registration only</small>
            </p>
          </div>
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
			<form action=<?php echo $_SERVER['PHP_SELF'] ?> method="post" id="companyadd">
             ...
             <div class="row gutter-xs">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select name="status" class="custom-select">
                      ...
                      <option value="3">Not in budget</option>
			  ...
			  <div class="form-group">
				<a onclick="openfunction()" href="javascript:void(0);" id ="more" class="more">Want to add more details</a>
			  </div>
			 ...
			 <div id="moredetails" style="display:none;">
              ...
              <div class="form-group">
                ...
                <input name="typeb" class="form-control" type="text">
              </div>
              <div class="form-group">
             ...
             <div class="row gutter-xs">
                <div class="col-sm-6">
                  <div class="form-group">
					...
					<input name="mono" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="monc">Mon Closing</label>
					<input name="monc" class="form-control" type="text">
					<input type = "checkbox" id="monc">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="tueo">Tue Opening</label>
					<input name="tueo" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="tuec">Tue Closing</label>
					<input name="tuec" class="form-control" type="text">
					<input type = "checkbox" id="tuec">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="wedo">Wed Opening</label>
					<input name="wedo" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="wedc">Wed Closing</label>
					<input name="wedc" class="form-control" type="text">
					<input type = "checkbox" id="wedc">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="thurso">Thurs Opening</label>
					<input name="thurso" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="thursc">Thurs Closing</label>
					<input name="thursc" class="form-control" type="text">
					<input type = "checkbox" id="thursc">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="frio">Fri Opening</label>
					<input name="frio" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="fric">Fri Closing</label>
					<input name="fric" class="form-control" type="text">
					<input type = "checkbox" id="fric">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="sato">Sat Opening</label>
					<input name="sato" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="satc">Sat Closing</label>
					<input name="satc" class="form-control" type="text">
					<input type = "checkbox" id="satc">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="suno">Sun Opening</label>
					<input name="suno" class="form-control" type="text">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="sunc">Sun Closing</label>
					<input name="sunc" class="form-control" type="text">
                  </div>
                </div>
              </div>
             <div class="form-group">
                <label for="gallery">Gallery</label>
                <input name="gallery" class="form-control" type="text">
              </div>
              <div class="form-group">
      ...
      <div class="layout-footer">
        <div class="layout-footer-body">
          ...
          <small class="copyright">2016 &copy; <a href="http://www.onestdevelopers.com/">Onest Developers </a></small>
        </div>
      </div>
    </div>
	...
	function openfunction()
	{
		...
		$('#companyadd').attr('action', 'addcompany.php');
