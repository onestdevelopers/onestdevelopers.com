...
<?php 
	...
	$query = "SELECT * FROM client WHERE cid='{$cid}'";
		if($result = mysqli_query($link,$query)){
			...
			if($assign!=0){
					$querysub = "Select sid,fname,lname from salesman where sid =".$assign;
					if($result3 = mysqli_query($link,$querysub)){
						while ($row3 = mysqli_fetch_array($result3)) {
							$assigned =$row3[1].' '.$row3[2];
						}
					}
					else{
						die("no");
		...
		header('Location:http://localhost:1234/admin/comapnytrial.php');
	}
}
?>
<html lang="en">
<head>
    ...
    <title>Profile &middot; Elephant Template &middot; The fastest way to build modern admin site for any platform, browser, or device</title>
      ...
      <div class="layout-content">
        <div class="profile">
              ...
              <div class="profile-container">
                <div class="profile-card" >
                  <div class="profile-overview">
                    <h1 class="profile-name">Toms Diner</h1>
					...
					<p><b>Assignd To :</b> <?php echo $assigned;?></p>
                  </div>
                  <div class="profile-info">
                    <ul class="profile-nav">
                      <li>
                        <a href="#">
                          <h3 class="profile-nav-heading"><?php echo $contact;?></h3>
                          <em>
                            <small>Contact</small>
                          </em>
                        </a>
                      ...
                      <li>
                        <a href="#">
                          <h3 class="profile-nav-heading"></b><?php echo substr($manager, 0, 10);?></h3>
                          <em>
                            <small>Manager</small>
                          </em>
                        </a>
                      ...
                      <li>
                        <a href="#">
                          <h3 class="profile-nav-heading"><?php echo $rating ?></h3>
                          <em>
                            <small>Rating</small>
                          </em>
                        </a>
          ...
          <div class="profile-body">
            <div class="profile-container">
              <h4>Type of Business : <?php echo $typeb;?>  </h4><br>
			  <h4>Opening Hours :</h4>
			  <h5>Monday : <?php echo $mono;?> to <?php echo $monc;?></h5>
			  <h5>Tuesday : <?php echo $tueo;?> to <?php echo $tuec;?></h5>
			  <h5>Wednesday : <?php echo $wedo;?> to <?php echo $wedc;?></h5>
			  <h5>Thursday : <?php echo $thurso;?> to <?php echo $thursc;?></h5>
			  <h5>Friday : <?php echo $frio;?> to <?php echo $fric;?></h5>
			  <h5>Satday : <?php echo $sato;?> to <?php echo $satc;?></h5>
			  <h5>Sunday : <?php echo $suno;?> to <?php echo $sunc;?></h5>
            </div>
          </div>
        </div>
      </div>
